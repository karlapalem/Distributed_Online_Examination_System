...
/**
 * Servlet implementation class RemoveUgMaintopic
 */
@WebServlet("/RemoveUgMaintopic")
public class RemoveUgMaintopic extends HttpServlet implements Serializable{
	private static final long serialVersionUID = 1L;
       
    
    public RemoveUgMaintopic() {
        super();
