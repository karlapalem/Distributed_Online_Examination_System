...
/**
 * Servlet implementation class Instructermaintopics
 */
@WebServlet("/Instructermaintopics")
public class Instructermaintopics extends HttpServlet implements Serializable{
	private static final long serialVersionUID = 1L;
       
    
    public Instructermaintopics() {
        super();
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException 
	{
		...
		res.setContentType("text/html");
	 	...
	 	try {
	 		...
	 		while(rs.next())
			{
			out.println("<li><span><A HREF='http://www.examination.com/PASS/instructersubtopics?topicId="+rs.getString(1)+"&maintopic="+rs.getString(2)+"'>"+rs.getString(2)+"</A></span></li>");
			
				}
	 		out.println("<br><br><tr><td>"
					+"<br><center><A HREF='http://www.examination.com/PASS/addmaintopic.html'>Add</A>&nbsp&nbsp&nbsp"
					+"<A HREF='http://www.examination.com/PASS/DeleteMainTopic'>Remove</A>");
