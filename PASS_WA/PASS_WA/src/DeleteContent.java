...
public class DeleteContent extends HttpServlet implements Serializable{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        Databaseopp d=new Databaseopp();
	 	ResultSet rs=d.ContentAvailDowloadDiplay(maintopic,subtopicname,type,name);
	    try {
	    	out.println("<!DOCTYPE html>");
		 	...
		 	int i=1;
       		out.println("<form action='http://www.examination.com/PASS/DeleteContentFromDB'>" 
			...
			+"<input type='hidden' name='subtopicname' value='"+request.getParameter("subtopicname")+"'/>"
       		...
       		if(rs==null)
    	 	{out.println("Notes are not available<br><br>");}
    	 	else{
    	 	while(rs.next())
		 	{
