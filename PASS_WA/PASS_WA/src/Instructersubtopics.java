...
/**
 * Servlet implementation class instructersubtopics
 */
@WebServlet("/instructersubtopics")
public class Instructersubtopics extends HttpServlet implements Serializable{
	private static final long serialVersionUID = 1L;
       
    
    public Instructersubtopics() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    ResultSet rs= (ResultSet) d.readSubtopics(request);
	 	...
	 	try
	 	{
			...
			out.println("<li><span><A HREF='http://www.examination.com/PASS/Instructeruploadexcesise?subtopicname="+rs.getString(1)+"&maintopic="+maintopic+"'>"+rs.getString(1)+"</A></span></li>");
		 	...
		 	out.println("<center><BR><BR><A HREF='http://www.examination.com/PASS/AddSubTopicpage?code="+code+"&maintopic="+maintopic+"'>Add</A>&nbsp&nbsp&nbsp&nbsp"
					+"<A HREF='http://www.examination.com/PASS/RemoveSubTopicpage?topicId="+code+"'>Remove</A>");
