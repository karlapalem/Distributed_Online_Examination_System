...
/**
 * Servlet implementation class UgAddMaintopic
 */
@WebServlet("/UgAddMaintopic")
public class UgAddMaintopic extends HttpServlet implements Serializable{
	private static final long serialVersionUID = 1L;
       
    
    public UgAddMaintopic() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		HttpSession aSesssion = request.getSession(false);
	 	...
	 	Databaseopp d=new Databaseopp();
		 	...
		 	if(i!=0)
		 	{
		 		out.println("<br><br>Successfully Added main topic");
		 	}
		 	else
