...
/**
 * Servlet implementation class Studentdownexcesisepage
 */
@WebServlet("/Studentdownexcesisepage")
public class Studentdownexcesisepage extends HttpServlet implements Serializable{
	private static final long serialVersionUID = 1L;
       
    
    public Studentdownexcesisepage() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		response.setContentType("text/html");
	 	...
	 	String topicId = (String) aSesssion.getAttribute("topicId");
	 	aSesssion.setAttribute("type",type);
	 	String email=(String)aSesssion.getAttribute("email");
	 	aSesssion.setAttribute("name",email);
	 	...
	 	out.println("    <h3>Available Downloads</h3>");
	 	...
	 	out.println("<li><span><A HREF='http://www.examination.com/PASS/FileDownloadservlet?subtopicname="+subtopicname+"&maintopic="+maintopic+"&filename="+rs.getString(1)+"'>"+rs.getString(1)+":</A></span></li>");
	 		System.out.println("\nfile name:::"+rs.getString(1));
	 	}}
	 	out.println("</ul></h4>    <h3>exams</h3>");
	 	out.println("     <h4> <ul class=\"categories\">");
	 	out.println("<A HREF='http://www.examination.com/PASS/AttemptExame?subtopicname="+subtopicname+"&maintopic="+maintopic+"'>Take Exams:</A>");
	 	
	 	if(type.equals("Graduate"))
	 	{
	 	out.println("</h4><center>Click on below link to go Back<br><br><A HREF='http://www.examination.com/PASS/SubTopics?topicId="+topicId+"&maintopic="+maintopic+"'>Back:</A></center><br><br>");
	 	}
	 	else
	 	{
	 		
	 	out.println("</h4><center>Click on below link to go Back<br><br><A HREF='http://www.examination.com/PASS/UgSubtopics?topicId="+topicId+"&maintopic="+maintopic+"'>Back:</A></center><br><br>");
		}
