...
/**
 * Servlet implementation class UgMainTopics
 */
@WebServlet("/UgMainTopics")
public class UgMainTopics extends HttpServlet implements Serializable{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		res.setContentType("text/html");
	 	...
	 	String email=(String)aSesssion.getAttribute("name");
 		...
 		while(rs.next())
		{
		out.println("<li><span><A HREF='http://www.examination.com/PASS/UgSubtopics?topicId="+rs.getString(1)+"&maintopic="+rs.getString(2)+"'>"+rs.getString(2)+"</A></span></li>");
