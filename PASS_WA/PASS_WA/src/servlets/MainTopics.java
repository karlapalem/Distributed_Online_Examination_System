...
/**
 * Servlet implementation class servmaintopics
 */
@WebServlet("/MainTopics")
public class MainTopics extends HttpServlet implements Serializable{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException 
	{
		...
		res.setContentType("text/html");
	 	...
	 	try {
	 		...
	 		while(rs.next())
			{
			out.println("<li><span><A HREF='http://www.examination.com/PASS/SubTopics?topicId="+rs.getString(1)+"&maintopic="+rs.getString(2)+"'>"+rs.getString(2)+"</A></span></li>");
				}
