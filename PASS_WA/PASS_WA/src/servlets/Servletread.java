 ...
 */
@WebServlet("/Servletread")
public class Servletread extends HttpServlet implements Serializable{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException 
	{
	    ...
	    Sturecord record=d.readRecord(req);
		...
		try 
		{
			...
			{
		 	status = d.insertRecord(record);
			if(status)
			{
				res.sendRedirect("http://www.examination.com/PASS/studentloginpage.html?.....SUCCESS.....");
			}
		 	else
