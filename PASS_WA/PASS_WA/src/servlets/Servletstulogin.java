...
/**
 * Servlet implementation class Servletstulogin
 */
@WebServlet("/Servletstulogin")
public class Servletstulogin extends HttpServlet implements Serializable{
	private static final long serialVersionUID = 1L;
       
    
    public Servletstulogin() {
        super();
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException 
	{
		...
		{	
			...
			String result = d.chekValid(record);
			...
			{
				if(result.equalsIgnoreCase("Graduate"))
				{
					res.sendRedirect("http://www.examination.com/PASS/MainTopics");
				}
				else
					res.sendRedirect("http://www.examination.com/PASS/UgMainTopics");
			}
