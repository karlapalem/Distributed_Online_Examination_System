...
/**
 * Servlet implementation class UgSubtopics
 */
@WebServlet("/UgSubtopics")
public class UgSubtopics extends HttpServlet implements Serializable{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException 
	{
	    ...
	    ResultSet rs= (ResultSet) d.readUgSubtopics(req);
	 	...
	 	try
	 	{
			...
			out.println("<li><span><A HREF='http://www.examination.com/PASS/Studentdownexcesisepage?subtopicname="+rs.getString(1)+"&maintopic="+maintopic+"'>"+rs.getString(1)+"</A></span></li>");
		 	...
		 	out.println("</h4><center>Click on below link to go Back<br><br><A HREF='http://www.examination.com/PASS/UgMainTopics'>Back:</A></center><br><br>");
