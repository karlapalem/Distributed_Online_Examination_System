...
/**
 * Servlet implementation class AttemptExame
 */
@WebServlet("/AttemptExame")
public class AttemptExame extends HttpServlet implements Serializable{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
	 ...
	 try
		...
		out.println("<!DOCTYPE html>");
	 	...
	 	out.println("    <h3>Available Tests to Attend</h3>");
	 	out.println("     <h4> <ul class=\"categories\">");
	 	
	 	Databaseopp d=new Databaseopp();
	 	ResultSet rs1=(ResultSet) d.ExampapersAvailDowloadDiplay(maintopic,subtopicname,type);
	 	if(rs1==null)
	 	...
	 	while(rs1.next())
	 	{
	 	out.println("<li><span><A HREF='http://www.examination.com/PASS/AttemptExamPassValues?subtopicname="+subtopicname+"&maintopic="+maintopic+"&testname="+rs1.getString(1)+"'>"+rs1.getString(1)+":</A></span></li>");
	 		System.out.println("\nfile name:::"+rs1.getString(1));
	 	}}
	 	out.println("</h4><br>Click on below link to go Back<br><br><A HREF='http://www.examination.com/PASS/Studentdownexcesisepage?subtopicname="+subtopicname+"&maintopic="+maintopic+"'>Back:</A><br><br>");
