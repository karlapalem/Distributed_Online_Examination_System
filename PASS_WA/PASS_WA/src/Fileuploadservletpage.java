...
/**
 * Servlet implementation class Fileuploadservletpage
 */
@WebServlet("/Fileuploadservletpage")
public class Fileuploadservletpage extends HttpServlet implements Serializable{
	private static final long serialVersionUID = 1L;
       
   
    public Fileuploadservletpage() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		response.setContentType("text/html");
	 	...
	 	String maintopic= (String)request.getParameter("maintopic");
	 	String subtopicname= (String)request.getParameter("subtopicname");
		 ...
		 out.println(" {");
		 out.println("	 var a = document.form1.filename.value;");
		 out.println("		var b = document.form1.file1.value;");
		 out.println("		");
		 out.println("		if(a.length==0)");
		 out.println("		{");
		 out.println("			alert(\"Please Enter filename\");");
		 out.println("			return false;			");
		 out.println("		}");
		 out.println("		if(b.length==0)");
		 out.println("		{");
		 out.println("			alert(\"Please Upload File \");");
		 out.println("			return false;");
		 out.println("		");
		 out.println("		}");
	 	...
	 	out.println("<form name='form1' action='http://www.examination.com/PASS/Fileuploadservlet' method='post'  enctype='multipart/form-data' onsubmit='return validate()'>"
	 	+"<input type='hidden' name='name' value='"+name+"' />"
	 	+"<font color='blue'><h3>Instructor</h3></font>"
		+"<input type='hidden' name='maintopic' id= 'maintopic' value='"+maintopic+"'/><br>"
		+"<input type='hidden' name='subtopicname' value='"+subtopicname+"'/><br>" 	
		+"Filename :<input  type='text'  name='filename'  /><br><br>" 
		+"Source :<input type='file' name='file1' /><br><br><br>"	
		+"<input class='submit' type='submit' value='Upload'></form><br><br><br>");
