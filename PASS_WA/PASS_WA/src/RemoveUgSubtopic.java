...
/**
 * Servlet implementation class RemoveUgSubtopic
 */
@WebServlet("/RemoveUgSubtopic")
public class RemoveUgSubtopic extends HttpServlet implements Serializable{
	private static final long serialVersionUID = 1L;
       
    
    public RemoveUgSubtopic() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int i= al.size();
		if(i==0)
		{out.println("Not Selected Sub topics");}
		else
		{
		b=d.removeUgSubtopics(i,al,code,type);
		
		 	if(b!=0)
		 	{
		 		out.println("<br>Successfully  Removeed main topics");
		 	}
		 	else
		 		out.println("Not removeed main topic");
		 	al.clear(); 
		}
