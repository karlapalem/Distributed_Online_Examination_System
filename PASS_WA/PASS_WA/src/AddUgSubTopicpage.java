...
/**
 * Servlet implementation class AddUgSubTopicpage
 */
@WebServlet("/AddUgSubTopicpage")
public class AddUgSubTopicpage extends HttpServlet implements Serializable{
	private static final long serialVersionUID = 1L;
       
  
    public AddUgSubTopicpage() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		response.setContentType("text/html");
	 	...
	 	aSesssion.setAttribute("code45",code);
		...
		out.println("<form name='form1' action='http://www.examination.com/PASS/AddUgSubtopic' method='get' onsubmit='return validate()' >"
