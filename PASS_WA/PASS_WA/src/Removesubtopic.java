...
/**
 * Servlet implementation class Removesubtopic
 */
@WebServlet("/Removesubtopic")
public class Removesubtopic extends HttpServlet implements Serializable{
	private static final long serialVersionUID = 1L;
       
    
    public Removesubtopic() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{
		b=d.removeSubtopics(i,al,code,type);
			if(b!=0)
		 	{
		 		out.println("<br>Successfully  Removeed Sub topics");
		 	}
		 	else
		 		out.println("Not removeed Sub topic");
		 	al.clear(); 
		}
