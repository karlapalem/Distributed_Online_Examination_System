...
/**
 * Servlet implementation class DeleteMainTopic
 */
@WebServlet("/DeleteMainTopic")
public class DeleteMainTopic extends HttpServlet implements Serializable{
	private static final long serialVersionUID = 1L;
       
   
    public DeleteMainTopic() {
        super();
	 	...
	 	ResultSet rs= (ResultSet) d.readMaintopics1(name);
		  ...
		  try {
	    	out.println("<!DOCTYPE html>");
		 	...
		 	int i=1;
       		out.println("<form action='http://www.examination.com/PASS/Removemaintopic'>" );
