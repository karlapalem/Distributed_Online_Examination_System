...
/**
 * Servlet implementation class RemoveSubTopicpage
 */
@WebServlet("/RemoveSubTopicpage")
public class RemoveSubTopicpage extends HttpServlet implements Serializable{
	private static final long serialVersionUID = 1L;
       
   
    public RemoveSubTopicpage() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    ResultSet rs= (ResultSet) d.readSubtopics1(request,name);
		  ...
		  try {
	    	out.println("<!DOCTYPE html>");
		 	...
		 	int i=1;
     		out.println("<form name='form1' action='http://www.examination.com/PASS/Removesubtopic' method='get' onsubmit='return validate()'>" );
     		while(rs.next())
     				{
