...
/**
 * Servlet implementation class AddUgSubtopic
 */
@WebServlet("/AddUgSubtopic")
public class AddUgSubtopic extends HttpServlet implements Serializable{
	private static final long serialVersionUID = 1L;
       
    
    public AddUgSubtopic() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Databaseopp d=new Databaseopp();
		 	...
		 	int i=d.addUgSubtopics(request,name);
		 	if(i!=0)
		 	{
		 		out.println("<br>Successfully Added Sub topic");
		 	}
		 	else
		 		out.println("Not added Sub topic");
